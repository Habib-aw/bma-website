                ...
                <div className="routes">
                    <Routes>
                        <Route
                            path="/"
                            element={
                                showMenuItems ? null : <Home times={times} />
                            }
                        />
                        <Route
                            path="/about"
                            element={showMenuItems ? null : <About />}
                        />
                        <Route
                            path="/contact"
                        ...
                        <Route
                            path="/donate"
                            element={showMenuItems ? null : <Donate />}
                        />
                        <Route
                            path="/privacy-policy"
                        ...
                        <Route
                            path="*"
                            element={showMenuItems ? null : <Error />}
                        />
                    </Routes>
                    <CookieConsent
                        buttonText="Ok"
                    ...
                    >
                        This website uses some essential cookies in order to
                        function.{' '}
